/* Hx — landing-page visuals ONLY (sticky nav + activity heatmap).
 * Auth/app logic lives in login.js / repos.js / repo.js (via hx-api.js).
 * The landing must NEVER auto-log-in anyone — login is an explicit choice on login.html. */
(function () {
